...
<div class="bg-[url('/images/top-hero-1.jpg')] h-[600px] flex justify-center items-center p-3 bg-cover">
    <div class="flex flex-col justify-center md:text-center p-5 bg-white bg-opacity-90 md:w-[800px]  md:h-[60%]">
