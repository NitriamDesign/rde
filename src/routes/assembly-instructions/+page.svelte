<script lang="ts">
    ...
    const schematicDocuments: AssemblyData[] = [
        { name: "SCH_HC", title: "HC-Style WI, 8, 9, R, F, Q", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_RC", title: "RC-All Styles", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_RF", title: "RF-All Styles", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_SF", title: "SF-All Styles", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_SH", title: "SH-Style 80,90", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_SL", title: "SL-Style 80,90", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_SM", title: "SM-All Styles", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_ST", title: "ST-All Styles", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_TU", title: "TU-Style 8,R,9,F,N,T", pdf: "/pdf/accessories-all.pdf" },
        { name: "SCH_UC", title: "UC-Style 8,4,9,F,T,N,Q", pdf: "/pdf/accessories-all.pdf" }
    ];
